...
<script>
	...
	function displayAfterApplyingRule() {
		...
		document.getElementById("afterApplyRuleDiv").innerHTML = jsEncodeURI(document
				.getElementById("userInput").value);
...
<body>
	...
	<div class="alignRight">
		<h3>
			<a href='#' onclick='overlay("sourcecode/Rule5.txt")'>Source
	...
	<table id="searchHeadTable" border=0>
		<tr>
			...
			<td width="40%">Sample inputs that could be used in textbox,
				<ul>
					<li>http://www.vshesh.com?name=John&address=256, 1st street, USA
					</li>
					<li>http://remote.vshesh.com?dana=% * + , - /&name=TOM</li>
					</ul>
			</td>
		</tr>
	</table>
