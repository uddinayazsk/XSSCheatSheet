...
<!-- header.jsp contains all common imports of this application -->
...
<body>
	<div id="ruleHeaderDiv">
		<h3>Rule Details: Rule Name with Brief Description</h3>
	</div>
	...
	<!-- For source code display as overlay -->
