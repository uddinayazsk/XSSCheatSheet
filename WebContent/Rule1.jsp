...
<body>
	...
	<div class="alignRight">
		<h3>
			<a href='#' onclick='overlay("sourcecode/Rule1.txt")'>Source
	...
	<table id="searchHeadTable" border=0>
		<tr>
			...
			<td width="40%">Sample inputs that could be used in textbox
				<ul>
					<li> &lt;div style='color:blue'&gt;Data in innerHTML of the HTML subcontext&lt;/div&gt;<div></div>
</li><li> &lt;div style='color:green'&gt;Data in innerHTML of the HTML subcontext&lt;/div&gt;<div></div>
					</ul>
			</td>
		</tr>
	</table>
